 ...
 */
public class CrossContextDependencyBadObjectNameTestCase extends AbstractDependencyTest
{
   public static Test suite()
   {
      return suite(CrossContextDependencyBadObjectNameTestCase.class);
   }
   
   public CrossContextDependencyBadObjectNameTestCase(String name)
   {
      super(name);
   }
   ...
   {
      return new TestDelegate("test:a=1,b=2");
   }
