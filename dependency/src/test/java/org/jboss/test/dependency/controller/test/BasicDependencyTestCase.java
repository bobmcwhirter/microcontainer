 ...
 * @version $Revision$
 */
public class BasicDependencyTestCase extends AbstractDependencyTest
{
   public static Test suite()
   {
      return suite(BasicDependencyTestCase.class);
   }
   
   public BasicDependencyTestCase(String name)
   {
      super(name);
   }
