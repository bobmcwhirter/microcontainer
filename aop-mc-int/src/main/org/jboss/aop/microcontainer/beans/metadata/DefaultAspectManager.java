...
/**
 * Bean to allow overriding of the aspect manager name and property in different environments
 * 
...
public class DefaultAspectManager
{
   ...
   public void setManagerBean(String name)
   {
      managerBean = name;
   }
   
   public void setManagerProperty(String name)
   {
