 ...
 * @version $Revision$
 */
public class MicrocontainerAdvisedAdvisorTestCase extends AOPMicrocontainerTest
{
   ...
   {
      return suite(MicrocontainerAdvisedAdvisorTestCase.class);
   }
   
   public MicrocontainerAdvisedAdvisorTestCase(String test)
   {
      super(test);
   }
}
