 ...
 * @version $Revision$
 */
public class MicrocontainerNotAdvisedNoAdvisorTestCase extends AOPMicrocontainerTest
{
   ...
   {
      return suite(MicrocontainerNotAdvisedNoAdvisorTestCase.class);
   }
   
   public MicrocontainerNotAdvisedNoAdvisorTestCase(String test)
   {
      super(test);
   }
}
