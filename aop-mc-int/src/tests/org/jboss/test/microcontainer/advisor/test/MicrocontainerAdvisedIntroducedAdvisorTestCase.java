 ...
 * @version $Revision$
 */
public class MicrocontainerAdvisedIntroducedAdvisorTestCase extends AOPMicrocontainerTest
{
   ...
   {
      return suite(MicrocontainerAdvisedIntroducedAdvisorTestCase.class);
   }
   
   public MicrocontainerAdvisedIntroducedAdvisorTestCase(String test)
   {
      super(test);
   }
}
