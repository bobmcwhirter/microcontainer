 ...
 * @version $Revision$
 */
public class MicrocontainerNotAdvisedProxyAdvisorOverloadedConstructorTestCase extends AOPMicrocontainerTest
{
   ...
   {
      return suite(MicrocontainerNotAdvisedProxyAdvisorOverloadedConstructorTestCase.class);
   }
   
   public MicrocontainerNotAdvisedProxyAdvisorOverloadedConstructorTestCase(String test)
   {
      super(test);
   }
}
