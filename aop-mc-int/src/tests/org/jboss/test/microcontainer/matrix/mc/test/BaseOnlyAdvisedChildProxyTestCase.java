...
public class BaseOnlyAdvisedChildProxyTestCase extends AOPMicrocontainerTest
{
   ...
   private static final int EXPECTED_ANNNOTATED_CHILD_BASEONLY = 1;
   ...
   {
      return suite(BaseOnlyAdvisedChildProxyTestCase.class);
   }

   public BaseOnlyAdvisedChildProxyTestCase(String name)
   {
      super(name);
   }
}
