...
public class SimpleBeanWithConstructorDependencyImpl implements Serializable, SimpleBeanWithConstructorDependency
{
   ...
   public SimpleBeanWithConstructorDependencyImpl(SimpleBean bean)
   {
      this.bean = bean;
   }

   public SimpleBeanWithConstructorDependencyImpl(GenericBeanFactory factory) throws Throwable
   {
